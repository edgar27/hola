...
<CENTER><h1>INTERES POR  MONTO</h1></CENTER>
<p></p>
<div> 
	<form action="interesmonto.php" method="post">
		<label for="fname">Monto</label>
		<input id="fname" type="number" step="any" name="Monto" required><br>
  ...
  echo 
  Capital($_POST['Monto'], $_POST['Renta'], $_POST['Cuota']);
  ?></p>  

...
<CENTER><h1> RENTA</h1></CENTER>
<p></p>
<div> 
	<form action="renta.php" method="post">
		<label for="fname">Interes</label>
		<input id="fname" type="number" step="any" name="interes" required><br>
  ...
  echo 
  Capital($_POST['Capital'], $_POST['interes'], $_POST['Cuota']);
  ?></p>  
